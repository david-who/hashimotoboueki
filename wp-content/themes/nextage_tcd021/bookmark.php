...
<?php /*
<ul class="bookmark clearfix">
 <li class="social1"><iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo get_permalink() ?>&amp;layout=button_count&amp;width=200&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:104px; height:21px;" allowTransparency="true"></iframe></li>
 <li class="social2"><a href="http://twitter.com/share" class="twitter-share-button" data-count="horizontal" data-via="<?php bloginfo('name'); ?>" data-related="milkcoffee1" data-lang="ja">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script></li>
<?php if (strtoupper(get_locale()) == 'JA') : //show only for japanese user ?>
