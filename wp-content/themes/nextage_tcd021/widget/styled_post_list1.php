...
?>
 <li class="clearfix">
   <a class="image" href="<?php the_permalink() ?>"><?php if ( has_post_thumbnail()) { the_post_thumbnail('size3'); } else { echo '<img src="'; bloginfo('template_url'); echo '/images/common/no_image3.jpg" alt="" title="" />'; }; ?></a>
   <div class="info">
    <?php if( $show_date == '1' ) { ?>
