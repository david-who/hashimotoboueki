...
class SMAdminUi {
	...
	public function setUi(){
		...
		add_settings_section('SM_main_section', '显示设置', array(&$this,'section_text_fn'), $this->file_path);
		add_settings_field('sm_show_price', '使用价格单位', array(&$this,'setting_show_price'), $this->file_path, 'SM_main_section');
		add_settings_field('sm_monetary_unit', '价格单位', array(&$this,'setting_monetary_unit'), $this->file_path, 'SM_main_section');
	...
	function validate($input) {
		...
		if ( !is_numeric( $input['sm_item_num']) || $input['sm_item_num'] < 0 || $output['sm_item_num'] > 300){
